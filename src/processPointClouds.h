...
public:
    ...
    std::unordered_set<int> RansacSegmentPlaneInner(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, float distanceTol);
    ...
    void clusterHelper(int indice, typename pcl::PointCloud<PointT>::Ptr cloud, std::vector<int> &cluster, KdTree *tree, float clusterTolerance, std::vector<bool> &processed);
